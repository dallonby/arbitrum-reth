//! Replays Sepolia block 269,591,880 (v60) through the multi-gas inspector
//! path — a StartBlock InternalTx then one EIP-1559 value-dispersing call — and
...
const BLOCK_NUMBER: u64 = 269_591_880;
const BLOCK_TIMESTAMP: u64 = 0x6a0c9a2c; // 1779210732
const HEADER_BASE_FEE: u128 = 0x1313ca0; // 20,004,000
const L1_BLOCK_NUMBER: u64 = 0xa60700;
const PARENT_HASH: B256 = b256!("e631a0a6cd5abd41dbbfc08607dc7654689d03ceeea7188fabbfeb1b50657334");
...
const SENDER: Address = address!("47d2c5f04168d92b57a2ca74311a7512b855d5d8");
const CANON_SENDER_POST: U256 = U256::from_limbs([0x060a202db50987c0, 0, 0, 0]);

const PRESTATE_JSON: &str = include_str!(concat!(
    "../../arb-spec-tests/fixtures/regression/sepolia_269591880/block_start_prestate.json"
));
const TX1: &str = include_str!(concat!(
    "../../arb-spec-tests/fixtures/regression/sepolia_269591880/tx1_raw.hex"
));
...
#[test]
fn sepolia_269591880_sender_net_charge_matches_canonical() {
